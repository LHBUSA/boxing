...
**Status:** built and tested. Since 2026-09-14 all four official sources (WBC, WBA, IBF, WBO) are approved; WBA, IBF and WBO are collected on staging, and the WBC collector is not built yet. Ingestion, the four-lane Title Map and body-native rankings are described in [TITLES_RANKINGS_INGESTION.md](TITLES_RANKINGS_INGESTION.md).
