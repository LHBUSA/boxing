...
const DIVISION_WORDS = [
  ...
  ['light_flyweight', ['light flyweight', 'junior flyweight', 'jr flyweight']],
  ['super_flyweight', ['super flyweight', 'junior bantamweight', 'jr bantamweight']],
  ['flyweight', ['flyweight']],
  ['super_bantamweight', ['super bantamweight', 'junior featherweight', 'jr featherweight']],
  ['bantamweight', ['bantamweight']],
  ['super_featherweight', ['super featherweight', 'junior lightweight', 'jr lightweight']],
  ['featherweight', ['featherweight']],
  ['super_lightweight', ['super lightweight', 'junior welterweight', 'jr welterweight', 'light welterweight']],
  ['lightweight', ['lightweight']],
  ['super_welterweight', ['super welterweight', 'junior middleweight', 'jr middleweight', 'light middleweight']],
