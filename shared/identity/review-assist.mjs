...
export async function buildIdentityReviewReport(store, { sourceKeys = ['nsac_nevada', 'florida_athletic_commission', 'nj_sacb', 'mo_office_of_athletics', 'pa_state_athletic_commission'], now = new Date().toISOString() } = {}) {
